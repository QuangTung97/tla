...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "67f7777f" /\ chksum(tla) = "e029cba0")
...
Start(self) == /\ pc[self] = "Start"
               /\ \/ /\ db_value' = db_value + 1
                  ...
                  \/ /\ pc' = [pc EXCEPT ![self] = "LRUDelete"]
                     /\ UNCHANGED <<db_value, cache_value, new_value, get_value>>

SetCache(self) == /\ pc[self] = "SetCache"
                  /\ IF new_value[self] > cache_value
...
\* Last modified Fri Feb 19 16:31:01 ICT 2021 by teko
