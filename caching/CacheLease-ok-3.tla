...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "9fd876b3" /\ chksum(tla) = "23f7a864")
...
client(self) == Start(self) \/ SetCache(self) \/ InvalidateCache(self)
...
\* Last modified Mon Feb 22 13:53:26 ICT 2021 by teko
